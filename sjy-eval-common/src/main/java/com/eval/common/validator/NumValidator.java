package com.eval.common.validator;
...
public class NumValidator extends ValidatorHandler<Integer> implements Validator<Integer> {
    ...
    public NumValidator(int min, int max, String fieldName) {
        this.min = min;
        this.max = max;
